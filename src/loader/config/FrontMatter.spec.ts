...
describe('FrontMatter,', () => {
  ...
  const preconditionTests : [string, any, string][] = [
    [
      'empty front matter',
      '---\n\n---\n',
      'pages[\'file.markdown\'].date must be a date string (got undefined)',
    ],
    [
      'date === \'jibberish\'',
      '---\ndate: jibberish\n---\n',
      'pages[\'file.markdown\'].date must be a date string (got \'jibberish\')',
    ],
    [
      'role of type number',
      '---\ndate: 2019-01-01\nrole: 0\n---\n',
      'pages[\'file.markdown\'].role must be \'page\' or \'category\' or undefined (got 0)',
    ],
    [
      'role === \'superhero\'',
      '---\ndate: 2019-01-01\nrole: \'superhero\'\n---\n',
      'pages[\'file.markdown\'].role must be \'page\' or \'category\' or undefined (got \'superhero\')',
    ],
    [
      'title of type boolean',
      '---\ndate: 2019-01-01\ntitle: true\n---\n',
      'pages[\'file.markdown\'].title must be a string or undefined (got true)',
    ],
    [
      'description === null',
      '---\ndate: 2019-01-01\ndescription: null\n---\n',
      'pages[\'file.markdown\'].description must be a string or undefined (got null)',
    ],
    [
      'permalink of type number',
      '---\ndate: 2019-01-01\npermalink: 3.1415\n---\n',
      'pages[\'file.markdown\'].permalink must be a string or undefined (got 3.1415)',
    ],
    [
      'layout of type number',
      '---\ndate: 2019-01-01\nlayout: -1\n---\n',
      'pages[\'file.markdown\'].layout must be a string or undefined (got -1)',
    ],
    [
      'image of type boolean',
      '---\ndate: 2019-01-01\nimage: false\n---\n',
      'pages[\'file.markdown\'].image must be a string or undefined (got false)',
    ],
    [
      'output of type number',
      '---\ndate: 2019-01-01\noutput: 12345\n---\n',
      'pages[\'file.markdown\'].output must be a boolean or undefined (got 12345)',
    ],
    [
      'categories of type number',
      '---\ndate: 2019-01-01\ncategories: 0\n---\n',
      'pages[\'file.markdown\'].categories[0] must be a string (got no array operator (0)) or pages[\'file.markdown\'].categories be undefined (got 0)',
    ],
    [
      'categories as array of numbers',
      '---\ndate: 2019-01-01\ncategories:\n  - 0\n---\n',
      'pages[\'file.markdown\'].categories[0] must be a string (got 0) or pages[\'file.markdown\'].categories be undefined (got [0])',
    ],
    [
      'category of type boolean',
      '---\ndate: 2019-01-01\ncategory: false\n---\n',
      'pages[\'file.markdown\'].category must be a string or undefined (got false)',
    ],
    [
      'tags of type number',
      '---\ndate: 2019-01-01\ntags: 0\n---\n',
      'pages[\'file.markdown\'].tags[0] must be a string (got no array operator (0)) or pages[\'file.markdown\'].tags be undefined (got 0)',
    ],
    [
      'tags as array of numbers',
      '---\ndate: 2019-01-01\ntags:\n  - 0\n---\n',
      'pages[\'file.markdown\'].tags[0] must be a string (got 0) or pages[\'file.markdown\'].tags be undefined (got [0])',
    ],
    [
      'feed of type number',
      '---\ndate: 2019-01-01\nfeed: 12345\n---\n',
      'pages[\'file.markdown\'].feed must be a boolean or undefined (got 12345)',
    ],
    [
      'limit of type string',
      '---\ndate: 2019-01-01\nlimit: \'5\'\n---\n',
      'pages[\'file.markdown\'].limit must be a number or undefined (got \'5\')',
    ],
  ];
