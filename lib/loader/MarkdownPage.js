...
var MarkdownPage = /** @class */ (function (_super) {
    ...
    MarkdownPage.prototype.render = function () {
        ...
        var _b = this.context, paramorph = _b.paramorph, page = _b.page, history = _b.history;
        var PLACEHOLDER = children;
        return (React.createElement(Content_1.default, __assign({ limit: 5 }, data), PLACEHOLDER));
    };
    return MarkdownPage;
