...
(function() {
  ...
  describe("PageFactory", function() {
    ...
    describe(`when calling .crate(${JSON.stringify(fullMatter)})`, function() {
      var result;
      result = null;
      beforeEach(function() {
    ...
    describe(`when calling .crate(${JSON.stringify(tagsMatter)})`, function() {
      var result;
      result = null;
      beforeEach(function() {
    ...
    describe(`when calling .crate(${JSON.stringify(categoriesMatter)})`, function() {
      var result;
      result = null;
      beforeEach(function() {
    ...
    return describe(`when calling .crate(${JSON.stringify(categoriesCategoryMatter)})`, function() {
      var result;
      result = null;
      beforeEach(function() {
