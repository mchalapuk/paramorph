...
var Loader = /** @class */ (function () {
    function Loader(structure, frontMatter, pageFactory, loadSource) {
    ...
    Loader.prototype.load = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var paramorph, specialDirs, collectionFileTuples, descriptions, images;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        descriptions = this.generateMissingDescriptions(paramorph);
                        images = this.addDefaultImages(paramorph);
                        return [4 /*yield*/, descriptions];
                    case 3:
                        _a.sent();
    ...
    Loader.prototype.generateMissingDescriptions = function (paramorph) {
        return __awaiter(this, void 0, void 0, function () {
            var history, renderer, pages, index, promises;
            var _this = this;
            return __generator(this, function (_a) {
                history = history_1.createMemoryHistory();
                renderer = new renderers_1.LoaderRenderer(history, paramorph, this.loadSource);
                pages = Object.keys(paramorph.pages)
                    .map(function (key) { return paramorph.pages[key]; });
                index = paramorph.pages['/'];
                promises = pages.map(function (page) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!(page instanceof model_1.Tag)) return [3 /*break*/, 2];
                                return [4 /*yield*/, this.descriptionFromPages(index, page)];
                            case 1:
                                description_1 = _a.sent();
                                Object.defineProperty(page, 'description', {
                                    get: function () { return description_1; },
                                    set: function () { throw new Error('Page.description is readonly'); },
                                });
                                return [3 /*break*/, 4];
                            case 2: return [4 /*yield*/, this.descriptionFromContent(renderer, page)];
                            case 3:
                                description_2 = _a.sent();
                                Object.defineProperty(page, 'description', {
                                    get: function () { return description_2; },
                                    set: function () { throw new Error('Page.description is readonly'); },
                                });
                                _a.label = 4;
    ...
    Loader.prototype.addDefaultImages = function (paramorph) {
        return __awaiter(this, void 0, void 0, function () {
            var history, renderer, pages, promises;
            var _this = this;
            return __generator(this, function (_a) {
                history = history_1.createMemoryHistory();
                renderer = new renderers_1.LoaderRenderer(history, paramorph, this.loadSource);
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.imageFromContent(renderer, page)];
                            case 1:
                                description = _a.sent();
    ...
    Loader.prototype.descriptionFromContent = function (renderer, page) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, renderer.render(page)];
                    case 1:
                        markup = _a.sent();
                        return [2 /*return*/, utils_1.removeEntities(utils_1.stripTags(markup))];
                }
            });
        });
    };
