...
var PageFactory = /** @class */ (function () {
    ...
    PageFactory.prototype.create0 = function (PageType, file, collection, matter) {
        ...
        return new PageType(matter.permalink || '', title, matter.description || '', matter.image || null, collection, matter.layout || '', file.path, matter.output || true, matter.feed || true, categories, matter.tags || [], new Date(matter.date).getTime());
    };
    return PageFactory;
}());
