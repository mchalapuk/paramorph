...
module.exports = function configLoader(source, map, meta) {
    ...
    var loader = new Loader_1.default(new ProjectStructure_1.default(fs), new FrontMatter_1.default(fs), new PageFactory_1.default(), function (request) { return new Promise(function (resolve, reject) {
        that.loadModule(request, function (err, source) {
            if (err) {
                reject(err);
            }
            else {
