  ...
  describe("Loader", function() {
    ...
    return describe("when loading a project structure containing page", function() {
      ...
      return describe("and after resolving frontMatter promise", function() {
        ...
        it('calls pageFactory.create(...)', function() {
          return mocks.pageFactory.create.should.have.callCount(1).and.have.been.calledWith(postSource, "posts", matter);
        });
        return describe("and after resolving promise from pageFactory", function() {
          var page;
          ...
          return it("resolves paramorph containing the page", function() {
            return paramorphPromise.then(function(paramorph) {
              return paramorph.pages.should.have.property("/hello-world").which.equal(page);
            });
          });
        });
      });
