...
var Content = /** @class */ (function (_super) {
    ...
    Content.prototype.renderComponent = function (elem, key) {
        var _a = this.props, respectLimit = _a.respectLimit, _b = _a.map, map = _b === void 0 ? function (node) { return node; } : _b, props = __rest(_a, ["respectLimit", "map"]);
        if (respectLimit && elem.type === 'img') {
            return null;
        }
        var children = this.renderChildren(elem.props.children);
        return map(react_1.cloneElement(elem, cloneProps(elem, props, key), children.length === 0 ? undefined : children));
    };
