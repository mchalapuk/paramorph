...
(function() {
  var Layout, React, Root, Route, ServerRenderer, createPage, createRoute, elem, layout, locals, models,
    slice = [].slice,
  ...
  Root = (function(superClass) {
    ...
    Root.prototype.render = function() {
      return elem("html", elem("head", elem("title", this.props.page.title)), elem("body", "%%%BODY%%%"));
    };
  ...
  describe("ServerRenderer", function() {
    ...
    return it("renders single page", function() {
      ...
      result = testedRenderer.render(locals, [
        {
          page: page,
          route: route
        }
      ...
      return result["/"].should.equal("" + "<!DOCTYPE html>\n" + "<html>" + "<head><title>Meeting</title></head>" + "<body><div data-reactroot=\"\"><p>Meeting</p></div></body>" + "</html>");
    });
  });
