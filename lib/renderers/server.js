...
var ServerRenderer = /** @class */ (function () {
    ...
    ServerRenderer.prototype.render = function (locals, paramorph, routes) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var router, pages, result, promises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        router = new universal_router_1.default(routes);
                        ...
                        promises = pages.map(function (page) { return __awaiter(_this, void 0, void 0, function () {
                            var component, history, app, body, root, html;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        app = react_1.createElement(ContextContainer_1.ContextContainer, { history: history, paramorph: paramorph, page: page }, component);
                                        body = server_1.renderToString(app);
                                        root = react_1.createElement(this.Root, getRootProps(locals, paramorph, page));
