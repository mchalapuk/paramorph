...
var asyncOpen = util_1.promisify(fs_1.open);
var asyncRead = util_1.promisify(fs_1.read);
var NodeFileSystem = /** @class */ (function () {
    ...
    NodeFileSystem.prototype.read = function (path, maxLength) {
        return __awaiter(this, void 0, void 0, function () {
            var buffer, fd, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        buffer = Buffer.alloc(maxLength);
                        return [4 /*yield*/, asyncOpen(path, 'r')];
                    case 1:
                        fd = _a.sent();
                        return [4 /*yield*/, asyncRead(fd, buffer, 0, maxLength, 0)];
                    case 2:
                        result = _a.sent();
