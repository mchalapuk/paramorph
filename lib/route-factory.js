    ...
    RoutesFactory.prototype.getRoutes = function (paramorph) {
        ...
        function createRoute(page, path) {
            ...
            return {
                ...
                route: {
                    path: path,
                    action: function (context, params) { return __awaiter(_this, void 0, void 0, function () {
                        var layout, component;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, paramorph.loadLayout(page.layout)];
                                case 1:
                                    layout = _a.sent();
                                    return [4 /*yield*/, paramorph.loadPage(path)];
                                case 2:
                                    component = _a.sent();
                                    return [2 /*return*/, (function () { return react_1.createElement(layout, { component: component, page: page, paramorph: paramorph }); })];
                            }
                        });
                    }); },
                },
